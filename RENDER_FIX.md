...
**المشكلة**: خطأ "Cannot open the app" عند الضغط على زر فتح التطبيق.

**الحل في خطوتين:**

**الخطوة 1: تحديث WEBHOOK_URL**
...
**الخطوة 2: تسجيل الـ Domain في BotFather (⚠️ مهم جداً!)**
1. افتح [@BotFather](https://t.me/botfather)
2. أرسل `/mybots` واختر البوت
3. اختر: **Bot Settings** → **Menu Button** → **Configure Menu Button**
4. أرسل الرابط: `https://your-app-name.onrender.com/mini-app`
5. أرسل اسم الزر: `فتح التطبيق`

📋 **للتفاصيل الكاملة**: راجع ملف `TELEGRAM_MINI_APP_SETUP.md`
