...
2. شكل الرقم القومي:
   ...
   ✓ استخدم الأرقام الإنجليزية/الغربية (0123456789) وليس العربية (٠١٢٣٤٥٦٧٨٩)
   ✓ مثال صحيح: 29501011234567
   ✓ مثال خاطئ: ۲۹۵۰۱۰۱۱۲۳۴۵۶۷ (أرقام عربية هندية)
...
❌ استخدام الأرقام العربية (٠١٢٣٤٥٦٧٨٩) أو الهندية (۰۱۲۳۴۵۶۷۸۹)
   🚨 يجب استخدام الأرقام الإنجليزية فقط: 0123456789
...
5. 🚨 لا تستخدم الأرقام العربية (٠١٢٣) أو الهندية (۰۱۲۳) - استخدم الإنجليزية فقط (0123)
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            nationalId: { 
              type: "string",
              description: "🚨 الرقم القومي - الأهم من كل شيء! 🚨 يتكون من 14 رقم بالضبط (لا أكثر ولا أقل). اقرأ كل رقم بتركيز شديد. ابحث عن كلمة 'الرقم القومي' أو 'National ID' في البطاقة. يجب استخدام الأرقام الإنجليزية/الغربية فقط (0123456789) وليس العربية (٠١٢٣) أو الهندية (۰۱۲۳). أمثلة صحيحة بالأرقام الإنجليزية: 29501011234567, 30105251234567, 28803141234567. ضع الأرقام فقط بدون مسافات أو رموز أو نصوص. يجب أن يكون 14 رقم إنجليزي بالضبط - راجع مرتين!"
            },
          },
